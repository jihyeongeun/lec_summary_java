...
public class Application {
    public static void main(String[] args) {
         ...
         *    2. 부모 클래스에서는 의미있고 중요했던 기능이 자식 클래스에서는 무의미할 수 있다.
         *       (불필요한 멤버가 추가되기 때문)
         *
         *  필기.
         *   메소드 오버라이딩이란?
         ...
         *   적용해야 한다.
         *   (IS-A관계 vs HAS-A관계)
         *    ex) student, computer -> student is a computer(X), student has a computer(O) (HAS-A관계)
         *        java, programming language -> java is a programming language(O) (IS-A관계)
         *        java - child programming language - parent
        * */
