...
public class WildCardFarm {
    ...
    /* 설명. 어떤 타입의 RabbitFarm(제네릭 타입)이 와도 상관이 없다. */
    public void anyType(RabbitFarm<?> farm){      //RabbitFarm 조건을 만족하는 어떤것이든 상관X
        farm.getAnimal().cry();
    }

    /* 설명. RabbitFarm 중에서도 Bunny 또는 Bunny 하위타입이 있는 RabbitFarm만 가능 (Bunny 이거나 Bunny 제네릭의 농장만 가능)*/
