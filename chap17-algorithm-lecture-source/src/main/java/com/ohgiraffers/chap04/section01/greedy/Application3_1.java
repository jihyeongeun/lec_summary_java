...
public class Application3_1 {
    ...
    public static int solution(String input) throws IOException {
        ...
        /* 설명.
         *  그리디 알고리즘으로 접근하자면 하나의 회의실에서 가장 많은 회의를
         *  열기 위해서는 종료시간 순(오름차순)으로 고민하는 것이 좋다.
...
//          /* 설명. 종료시간이 같은 회의에 대해서는 */
        ...
        /* 설명. 회의가 끝나는 시간을 담아놓을 변수 선언 */
        int end = 0;

        /* 설명. time 배열에 담긴 회의들을 확인하여 앞선 회의의 종료 다음 회의가 진행되는지를 판변해 가능한 회의 추출 */
        for (int i = 0; i < N; i++) {
